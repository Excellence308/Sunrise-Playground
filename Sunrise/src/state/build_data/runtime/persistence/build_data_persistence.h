...
struct Context {
    ...
    std::unique_ptr<vendors::IndexEntry[]> vendorIndexScratch{};
    std::unique_ptr<vendors::Definition[]> vendorDefinitionScratch{};
    std::unique_ptr<vendors::SaleRow[]> vendorSaleRowScratch{};
    std::unique_ptr<vendors::InstalledRow[]> vendorInstalledRowScratch{};
